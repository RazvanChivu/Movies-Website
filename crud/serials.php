...
<body>
    <div class="container">
        <button class="btn btn-primary my-5"><a href="addserials.php" class="text-light">Add series</a>
        </button>
  ...
  if($result){
      while ($row=mysqli_fetch_assoc($result)){
          ...
          <td>'.$picture.'</td>
          <td>
        <button class ="btn btn-primary"><a href="updateSerials.php?updateid='.$id.'
        "class=text-light">Update</a></button>
        <button class ="btn btn-danger"><a href="deleteSerials.php?deleteid='.$id.' " 
