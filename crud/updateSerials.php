...
if( isset($_POST['submit']) )
{
  ...
  $sqlg = "SELECT picture FROM serials WHERE id='$id'";
  ...
  if(move_uploaded_file($tempname, $folder)){
    $sql = "update serials set title='$title', genre='$genre', description='$description', year='$year', picture='$picture' where id='$id'";
    ...
    <div class="container my-5">
        <form method="post" enctype="multipart/form-data">
          <div class="form-group">
            ...
            <input type="text" class="form-control" placeholder="Update series' title" name="title" autocomplete="off">
            </div>
