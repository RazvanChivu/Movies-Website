...
if( isset($_POST['submit']) )
{
  ...
  if(move_uploaded_file($tempname, $folder)){
    $sql = "INSERT INTO serials (title,genre,description,year,picture) VALUES ('$title', '$genre', '$description','$year','$picture')";
    ...
    <div class="container my-5">
        <form method="post" enctype="multipart/form-data">
          <div class="form-group">
            ...
            <input type="text" class="form-control" placeholder="enter series title" name="title" autocomplete="off">
            </div>
